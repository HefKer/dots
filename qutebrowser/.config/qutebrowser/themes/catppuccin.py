# Source: "https://github.com/catppuccin/qutebrowser"

"""
Setup:

from themes import catppuccin
catppuccin.set(c, flavour = 'mocha', samecolorrows = False) # Flavors: 'mocha', 'macchiato', 'frappe', 'latte'

"""


def set(c, flavour, samecolorrows=False):
    palette = {}
